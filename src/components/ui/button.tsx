...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-brand-accent text-brand-bg hover:bg-brand-accent-hover font-semibold",
        outline:
          "border border-brand-border bg-transparent hover:bg-brand-elevated text-brand-text",
        secondary:
          "bg-brand-elevated text-brand-text hover:bg-brand-elevated/80",
        ghost: "hover:bg-brand-elevated text-brand-text",
