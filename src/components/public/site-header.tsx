  ...
  return (
    <header className="sticky top-0 z-50 overflow-x-clip bg-brand-bg/80 backdrop-blur">
      ...
      <div className="container flex h-12 items-stretch gap-6 sm:h-14 sm:gap-10">
        ...
        <div className="relative flex flex-1 items-center self-stretch -mr-5 pr-5 after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-[linear-gradient(to_right,transparent,#2a2a2a_7%)] sm:-mr-6 sm:pr-6 lg:-mr-10 lg:pr-10 xl:-mr-14 xl:pr-14 2xl:-mr-20 2xl:pr-20">
